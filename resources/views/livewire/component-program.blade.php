<div class="p-2">
                    ...
                    @foreach ($meetings as $meeting)
                        <tr
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-left">
                                <ul>
                                    <li>
                                        <a wire:click='modalAttended({{ $meeting->id }})'
    ...
    <x-dialog-modal wire:model="attendedModal">
        <x-slot name="title">
        ...
        <x-slot name="footer">
            <x-btn-red wire:click="$set('attendedModal', false)" wire:loading.attr="disabled" class="w-1/3">
                {{ __('Cancel') }}
            </x-btn-red>

            <x-btn-blue class="ml-2" wire:click='updateAttendance' wire:loading.attr="disabled" class="w-1/3">
                {{ __('Accept') }}
            </x-btn-blue>
        </x-slot>
    </x-dialog-modal>
